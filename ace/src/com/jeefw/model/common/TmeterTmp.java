...
/**
 * The persistent class for the TMETER_TMP database table.
 * 
 */
@Entity
@Table(name="TMETER_TMP")
@NamedQuery(name="TmeterTmp.findAll", query="SELECT t FROM TmeterTmp t")
public class TmeterTmp implements Serializable {
