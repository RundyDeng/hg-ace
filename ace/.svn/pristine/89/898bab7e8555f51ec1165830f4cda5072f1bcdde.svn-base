...
/**
 * The persistent class for the TMETERBACK database table.
 * 
 */
@Entity
@NamedQuery(name="Tmeterback.findAll", query="SELECT t FROM Tmeterback t")
public class Tmeterback implements Serializable {
