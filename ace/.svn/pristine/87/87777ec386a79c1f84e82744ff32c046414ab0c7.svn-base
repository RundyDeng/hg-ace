...
/**
 * The persistent class for the LSTMETER database table.
 * 
 */
@Entity
@NamedQuery(name="Lstmeter.findAll", query="SELECT l FROM Lstmeter l")
public class Lstmeter implements Serializable {
