		...
		$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	jQuery(function($) {
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : $path_base + "/baseinfomanage/meterinfoController/getmeterinfo",
        			datatype : "json",
        			height : 450,
        			rownumbers:true,
        			...
        			editurl : $path_base + "/baseinfomanage/meterinfoController/operMeterInfo"
        		});
        		...
        		function submitExcel(){
        			...
        			var form = "<form name='csvexportform' action='" + $path_base + "/baseinfomanage/meterinfoController/operMeterInfo?oper=excel' method='post'>";
