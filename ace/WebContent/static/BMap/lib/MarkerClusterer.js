...
(function(){
    ...
    MarkerClusterer.prototype._createClusters = function(){
        ...
        console.log("mapBoundsmapBoundsmapBoundsmapBounds")
    ...
    MarkerClusterer.prototype._addToClosestCluster = function (marker){
        ...
        if (clusterToAddTo && clusterToAddTo.isMarkerInClusterBounds(marker)){
            ...
            if(marker.V != null){
                var areaName = marker.V.title;
                var myLabel = new BMap.Label("<a class='map-label-area' href='javascript:;'>大同<br>"+ areaName +"<br>开发部</a>");
                myLabel.setStyle({        
                    color: "yellow",fontSize: "14px",border: "0",height: "74px",width: "74px",
                    overflow: "hidden",textAlign: "cneter",lineHeight: "120px",
                    background: "url("+basePath+"/static/BMap/img/bg.png) no-repeat -1px -1px",cursor: "pointer"
                });
                marker.setLabel(myLabel);
                marker.addEventListener("mouseover",function(e){myLabel.setStyle({backgroundPosition: "0px -88px"});});
                marker.addEventListener("mouseout",function(e){myLabel.setStyle({backgroundPosition: "-1px -1px"});});
            }
        }    
    };
