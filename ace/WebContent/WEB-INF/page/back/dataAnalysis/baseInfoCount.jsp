...
var commitSetting = function(sel){
	...
	var getStatisticInfo = function(){
		 ...
		 $.get('${contextPath}/dataAnalysis/baseInfoCountContr/getBaseInfoCount?page='+page+'&date=' + date +'&areaNo=' + areaNo + '&position='+position + '&brand='+brand,function(response){
	...
	function showTable(jsonData){
		...
		$(jsonData).each(function(index ,obj){
			//alert(obj.reliang);
			trs += '<tr><td>' + obj.meters + '</td>';
			trs += '<td>' + obj.status + '</td>';
			trs += '<td>' + obj.hotarea + '</td>';
			trs += '<td>' + obj.reliang + '</td></tr>';
		});
