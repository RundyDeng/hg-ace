        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	jQuery(function($) {
        		...
        		var template1 = { 
        				"groupOp": "AND", 
        				"rules": [ 
									 { "field": "departmentKey", "op": "eq", "data": "" } , 
									 { "field": "departmentValue", "op": "cn", "data": "" } ,
        		...
        		jQuery(grid_selector).jqGrid('navGrid', pager_selector, { // navbar options
        			...
        			view : <shiro:hasPermission name="${ROLE_KEY}:department:view">false</shiro:hasPermission><shiro:lacksPermission name="${ROLE_KEY}:department:view">false</shiro:lacksPermission>,
