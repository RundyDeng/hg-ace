        ...
        $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        	...
        	/////
        		...
        		jQuery(grid_selector).jqGrid({
        			subGrid : false,
        			url : "${contextPath}/searchData/hisFault/getHisFault",
        			datatype : "json",
        			height : 450,
        			rownumbers:true,
        			rownumWidth:40,
        		...
        		function submitExcel(){
    			   ...
    			   if(areaguid=='')
    				   return;
      			   $.get('${contextPath}/searchData/hisFault/operHisFault?oper=excel&flag=1&date1='+date1+"&date2="+date2+"&areaguid=" + areaguid,function(data){
      				   
      				   if(data==1){
      					   alert('此时间段没有数据！');
      				   }else{
      					   var form = "<form name='csvexportform' action='${contextPath}/searchData/hisFault/operHisFault?oper=excel&&date1="+date1+"&date2="+date2+"&areaguid=" + areaguid+"' method='post'>";
