...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
		...
		$("#btn_cb").click(function(){	
		  ...
		  var doorno=$("#selDoorname").val();
			  $.post("${contextPath}/readmeter/readingMeter/getUserInfo?areaguid="+$(select_area).val()+"&doorno="+$("#selDoorname").val()+"&buildno="+$("#selBuild").val()+"&unitno="+$("#selUnit").val()+"&floorno="+$("#selFloor").val(), function (data) {  
